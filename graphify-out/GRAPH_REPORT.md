...
## Corpus Check
- 1028 files · ~200,000 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1028 nodes · 1445 edges · 67 communities detected
- Extraction: 64% EXTRACTED · 36% INFERRED · 0% AMBIGUOUS · INFERRED: 527 edges (avg confidence: 0.87)
...
1. `Texture()` - 25 edges
2. `Shader()` - 23 edges
3. `SceneRenderer()` - 21 edges
4. `Framebuffer()` - 20 edges
...
Cohesion: 0.04
Nodes (46): OpenGL State Management Pattern, ImGui Frame Lifecycle, Dear ImGui Integration, Common ImGui Widgets, StartWindow/EndWindow Panel API, UIManager Wrapper Class, Framebuffer RAII Design, Texture Lifetime Management (+38 more)
...
Cohesion: 0.05
Nodes (44): CPU-GPU Memory Divide and Data Transfer Cost, GLSL Vertex and Fragment Shaders, OpenGL Graphics Pipeline (Vertex → Fragment → Framebuffer), MVP Matrix and Coordinate Space Transformations, Chapter 7: OpenGL Fundamentals, OpenGL State Machine (Bind Before Use), Rationale: Upload Data to GPU Once to Minimize Transfer Cost, Uniforms: Passing Data from C++ to Shaders (+36 more)

### Community 4 - "Physically Based Rendering Pipeline"
Cohesion: 0.05
Nodes (50): Camera(), VizEngine_API Export/Import Macros (dllexport/dllimport), Shader RAII and Move Semantics, Shader System, stb_image Vendor Integration, Texture RAII and Move Semantics, Texture System, Camera Class (+42 more)
...
Cohesion: 0.08
Nodes (25): Blinn-Phong Illumination Model, DirectionalLight Struct, PointLight with Attenuation, Light-Space Matrix, Orthographic Light Projection, Monolith Refactoring (SandboxApp 1660â†’970 lines), Dirty Flag Upload Pattern, GPUPointLight & std430 Layout (+17 more)
...
Cohesion: 0.09
Nodes (24): Bloom(), Energy-Conserving Kernel, Gaussian Blur Pass, Separable Two-Pass Blur, Bright-Pass Extraction, Perceptual Luminance Weighting, Quadratic Soft Threshold (Knee), Process() (+16 more)

### Community 10 - "PBRMaterial Class API"
Cohesion: 0.1
Nodes (25): Combined Shader File Format, MVP Matrix Uniform, Shader Compilation and Linking, Shader Compile Error Reporting, Shader File Parsing, Uniform Location Caching, Euler Angle Rotation in Radians, Model Matrix Construction (TRS Order) (+17 more)

### Community 11 - "Engine Architecture & Future Roadmap"
Cohesion: 0.08
Nodes (27): Screen and Depth Buffer Clear, Centralized Draw Call Abstraction, Renderer Class, Homogeneous Coordinates (vec4 Position), Mesh Class, Vertex Data Structure, Shared Mesh Ownership, glTF Accessor/BufferView/Buffer Hierarchy (+19 more)
...
Cohesion: 0.16
Nodes (14): ForwardRenderPath, Strategy Pattern for Render Paths, ForwardRenderPath SetupLighting Update, GLSL SSBO LightBuffer Block, Ch46: Forward+ Rendering, Ch47: Deferred Rendering, Ch50: Render Path Comparison, Execute() (+6 more)
...
Cohesion: 0.15
Nodes (13): Dual Material Approach, SceneObject Struct Design, Object Inspector Panel, RenderPassData Struct, RenderPassData Refactor (LightManager* Lights), ShaderStorageBuffer SetData Allocation Strategy, ShaderStorageBuffer (RAII SSBO Wrapper), Light Management & SSBOs (+5 more)
...
Cohesion: 0.4
Nodes (2): Scene Object Lifecycle, Update()
...
- **Thin community `DLL Export Macro`** (2 nodes): `Ch06: Window & Context`, `GLFWManager`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Camera Controller & Delta Time (Code)`** (2 nodes): `Ch21: Input System`, `Input`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
