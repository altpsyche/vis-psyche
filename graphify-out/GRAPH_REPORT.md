...
## Corpus Check
- 888 files · ~200,000 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 888 nodes · 1166 edges · 78 communities detected
- Extraction: 55% EXTRACTED · 45% INFERRED · 0% AMBIGUOUS · INFERRED: 527 edges (avg confidence: 0.87)
...
- [[_COMMUNITY_Camera Controller & Delta Time (Docs)|Camera Controller & Delta Time (Docs)]]
- [[_COMMUNITY_Shadow Map Texture Wrap Config|Shadow Map Texture Wrap Config]]
- [[_COMMUNITY_Texture Filtering Rationale|Texture Filtering Rationale]]
- [[_COMMUNITY_Alpha Channel in ObjectColor|Alpha Channel in ObjectColor]]
- [[_COMMUNITY_Engine Singleton & Book Overview|Engine Singleton & Book Overview]]
- [[_COMMUNITY_GLFW Window & Context|GLFW Window & Context]]

## God Nodes (most connected - your core abstractions)
1. `Texture()` - 24 edges
2. `Shader()` - 22 edges
3. `SceneRenderer()` - 20 edges
4. `Framebuffer()` - 19 edges
5. `Chapter 9: Buffer Classes` - 16 edges
6. `VizPsyche Engine` - 16 edges
7. `PBRMaterial()` - 15 edges
8. `Sandbox::OnCreate` - 14 edges
9. `Chapter 6: Window & Context` - 13 edges
10. `Chapter 7: OpenGL Fundamentals` - 13 edges
...
- `Shader System` --teaches--> `Bind()`  [INFERRED]
...
- `MVP Matrix Uniform` --teaches--> `SetMatrix4fv()`  [INFERRED]
  VizEngine/docs/vis-psyche-docs/chapters/10_ShaderAndRenderer.md → VizEngine\src\VizEngine\OpenGL\Shader.cpp
- `Texture System` --references--> `Bind()`  [INFERRED]
  VizEngine/docs/vis-psyche-docs/chapters/11_Textures.md → VizEngine\src\VizEngine\OpenGL\Shader.cpp
...
- **Light Ownership Refactor: raw pointers → LightManager + SSBO (Ch44)** — ch44_ssbo_light_management, ch44_light_manager, ch44_shader_storage_buffer, ch44_render_pass_data_update, ch44_scene_renderer_api, ch44_forward_render_path_update [EXTRACTED 0.95]
...
Cohesion: 0.05
Nodes (49): Camera(), VizEngine_API Export/Import Macros (dllexport/dllimport), Shader RAII and Move Semantics, Shader System, stb_image Vendor Integration, Texture RAII and Move Semantics, Texture System, Camera Class (+41 more)
...
Cohesion: 0.07
Nodes (36): VBO, IBO, and VAO Buffer Types, Delete Copy Operations, Allow Move Operations for OpenGL Wrappers, Move Semantics: Ownership Transfer via std::move, Null-After-Move: Set m_ID to 0 to Prevent Double-Delete, RAII Pattern: Constructor Acquires, Destructor Releases, Chapter 8: RAII & Resource Management, Rationale: Delete Copy Because GPU Resources Cannot be Cheaply Duplicated, Rationale: noexcept on Move Operations for std::vector Optimization (+28 more)

### Community 4 - "Physically Based Rendering Pipeline"
Cohesion: 0.06
Nodes (34): Roughness to Shininess Mapping, Cook-Torrance BRDF, Fresnel-Schlick Approximation, GGX Normal Distribution Function, Metallic-Roughness Material Workflow, Energy Conservation Implementation, F0 Metallic Workflow, PBRMaterial Class Integration (+26 more)

### Community 5 - "Shader & Framebuffer System"
Cohesion: 0.07
Nodes (38): OpenGL State Management Pattern, Framebuffer RAII Design, Texture Lifetime Management, Polygon Offset for Acne, Framebuffer-Based Cubemap Baking, Combined Depth-Stencil FBO Attachment, Renderer DLL State Wrapping, Blending Equation (+30 more)

### Community 6 - "Scene Architecture + Advanced Render Chapters"
Cohesion: 0.06
Nodes (34): Framebuffer Resize Callback (FramebufferSizeCallback), GLFWManager GLFW Encapsulation, OpenGL Debug Output (GL_DEBUG_OUTPUT), VizEngine/OpenGL Subdirectory Structure, Rationale: GLFWManager Constructor Does All Initialization (No Separate Init), Rationale: Game Loop Ownership in Application::Run (Future Engine Class), Chapter 6: Window & Context, CPU-GPU Memory Divide and Data Transfer Cost (+26 more)

### Community 7 - "Appendix + Advanced Rendering Chapters"
Cohesion: 0.08
Nodes (29): Bloom(), Energy-Conserving Kernel, Gaussian Blur Pass, Separable Two-Pass Blur, Bright-Pass Extraction, Perceptual Luminance Weighting, Quadratic Soft Threshold (Knee), Process() (+21 more)

### Community 8 - "Renderer Command API"
Cohesion: 0.08
Nodes (26): Blinn-Phong Illumination Model, DirectionalLight Struct, PointLight with Attenuation, Light-Space Matrix, Orthographic Light Projection, Monolith Refactoring (SandboxApp 1660â†’970 lines), Dirty Flag Upload Pattern, ForwardRenderPath SetupLighting Update (+18 more)

### Community 9 - "HDR + Post-Processing Pipeline"
Cohesion: 0.08
Nodes (22): Screen and Depth Buffer Clear, Centralized Draw Call Abstraction, Renderer Class, Homogeneous Coordinates (vec4 Position), Mesh Class, Vertex Data Structure, Shared Mesh Ownership, glTF Accessor/BufferView/Buffer Hierarchy (+14 more)
...
Cohesion: 0.1
Nodes (21): Mipmap Generation, Texture Filtering Modes, OpenGL Texture Slots, Texture Wrapping Modes, Framebuffer Completeness Validation, Texture Border Color, Texture Filtering Modes, SetFilter Method (+13 more)

### Community 12 - "Application & Event System Docs"
Cohesion: 0.17
Nodes (15): GetForward(), GetRight(), GetUp(), Move(), MoveForward(), MoveRight(), MoveUp(), RecalculateViewMatrix() (+7 more)
...
Cohesion: 0.15
Nodes (13): Engine Owns the Game Loop, Exception-Safe Game Loop, Subsystem Accessor Pattern with Assert, CreateApplication Factory Function, Event Base Class, Event Flow Pipeline, Event Propagation and Handled Flag, FPS and Delta Time Tracking (+5 more)

### Community 16 - "Input & Event System Code"
Cohesion: 0.15
Nodes (11): IBL Foundation, IBL Generation Startup Cost, Irradiance Map (Diffuse IBL), Pre-filtered Environment Map (Specular IBL), GenerateIrradianceMap(), GeneratePrefilteredMap(), Irradiance Hemisphere Convolution Integral, Irradiance Tangent-Space Basis Construction (+3 more)

### Community 17 - "GLFW Window & Input Callbacks"
Cohesion: 0.19
Nodes (11): Framebuffer Attachments, Render-to-Texture Workflow, Viewport Management, Two-Pass Rendering, AttachColorTexture(), AttachDepthTexture(), Bind(), Unbind() (+3 more)

### Community 18 - "Camera System (Code)"
Cohesion: 0.15
Nodes (12): Dual Material Approach, SceneObject Struct Design, Object Inspector Panel, RenderPassData Struct, RenderPassData Refactor (LightManager* Lights), ShaderStorageBuffer SetData Allocation Strategy, ShaderStorageBuffer (RAII SSBO Wrapper), Light Management & SSBOs (+4 more)

### Community 19 - "RenderMaterial Class API"
Cohesion: 0.18
Nodes (11): glDrawElementsInstanced, glVertexAttribDivisor, GPU Instancing, mat4 Split Across 4 Attribute Locations, Blinn-Phong Lighting for Instanced Objects, Instance Normal Matrix Derivation, Per-Instance Model Matrix (location 6-9), Instanced Rendering Vertex Shader (+3 more)

### Community 20 - "Entity-Component System Concept"
Cohesion: 0.18
Nodes (10): CubemapUtils Class, Equirectangular-to-Cubemap Conversion, Environment Reflections Preview, Image-Based Lighting (IBL) Overview, Image-Based Lighting Pipeline, CubemapUtils, EquirectangularToCubemap(), Equirectangular HDR Environment Sampling (+2 more)

### Community 21 - "Model Loading System"
Cohesion: 0.24
Nodes (6): Single Bind() Call Pattern, UploadParameters via std::visit, Bind(), BindTextures(), SetInt(), UploadParameters()
...
Cohesion: 0.22
Nodes (6): Optional Attribute Safe Fallbacks, ComputeTangents Algorithm, glTF TANGENT Attribute Loading, Gram-Schmidt Orthogonalization, Chapter 34: Normal Mapping, ComputeTangents()
...
Cohesion: 0.28
Nodes (9): SetRotation(), Edge Detection (Pressed vs Held vs Released), Mouse Delta with First-Frame Guard, Right-Click Mouse Look, OnUpdate Camera Controller Integration, GetMouseDelta(), IsKeyPressed(), Camera Controller (+1 more)

### Community 29 - "ForwardRenderPath API"
Cohesion: 0.25
Nodes (9): Fresnel Schlick Approximation, Smith Geometry Function (IBL variant), Hammersley Quasi-Random Sequence, GGX Importance Sampling, BRDF Integration LUT Generation, Split-Sum BRDF Approximation, BRDF Integration LUT, GenerateBRDFLUT() (+1 more)

### Community 30 - "Engine Dependencies"
Cohesion: 0.22
Nodes (7): Disable Depth Mask for Skybox, Depth Mask Control, StencilFunc / StencilOp / StencilMask Trio, Two-Pass Stencil Outline Algorithm, Depth Mask Off During Transparent Pass, SetDepthMask(), SetStencilFunc()

### Community 31 - "UV Coordinate System"
Cohesion: 0.22
Nodes (7): Combined Shader File Format, Shader Compilation and Linking, Shader Compile Error Reporting, Shader File Parsing, Uniform Location Caching, CreateShader(), ShaderParser()
...
Cohesion: 0.33
Nodes (5): RecalculateProjectionMatrix(), SetAspectRatio(), SetFOV(), Field of View Control, Scroll Wheel FOV Zoom
...
Cohesion: 0.5
Nodes (1): ModelLoader::Load()

### Community 55 - "glTF Format Concepts"
Cohesion: 0.5
Nodes (4): Static Factory with Null Return, glTF pbrMetallicRoughness Extraction, OnCreate for Asset Loading and Scene Setup, LoadFromFile()
...
Cohesion: 0.67
Nodes (2): Viewport Management, Viewport Stack for Multi-Pass Rendering
...
Cohesion: 1.0
Nodes (1): Scene Object Lifecycle

### Community 63 - "Shadow Map Texture Config"
Cohesion: 1.0
Nodes (1): Common ImGui Widgets

### Community 64 - "Alpha Channel Design"
Cohesion: 1.0
Nodes (1): Static Input API Design

### Community 65 - "Input System Hook"
Cohesion: 1.0
Nodes (1): Input Update/EndFrame Lifecycle

### Community 66 - "Error Handling Hook"
Cohesion: 1.0
Nodes (1): Stencil Buffer

### Community 67 - "Singleton Pattern"
Cohesion: 1.0
Nodes (1): Separation: Material vs Renderer Responsibilities
...
### Community 72 - "Camera Controller & Delta Time (Docs)"
Cohesion: 1.0
Nodes (2): Camera, Ch14: Camera System

### Community 74 - "Texture Filtering Rationale"
Cohesion: 1.0
Nodes (1): ImGui Frame Lifecycle

### Community 75 - "Alpha Channel in ObjectColor"
Cohesion: 1.0
Nodes (1): StartWindow/EndWindow Panel API

### Community 76 - "Engine Singleton & Book Overview"
Cohesion: 1.0
Nodes (1): Standard Alpha Blending

### Community 77 - "GLFW Window & Context"
Cohesion: 1.0
Nodes (1): Lower Hemisphere Fallback Color

## Knowledge Gaps
- **308 isolated node(s):** `Book Structure and Parts Overview`, `OpenGL Pipeline Overview (Buffers, Shaders, Textures)`, `Visual Studio 2022 with C++ Workload`, `CMake 3.16+ Build System Setup`, `Git 2.30+ Version Control Setup` (+303 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Shadow Pass API`** (1 nodes): `ModelLoader::Load()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Error Handling System`** (2 nodes): `Viewport Management`, `Viewport Stack for Multi-Pass Rendering`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Camera Controller & Delta Time (Code)`** (2 nodes): `UV Texture Coordinates`, `Vertical Flip for OpenGL Origin`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Texture Filtering`** (1 nodes): `Scene Object Lifecycle`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Shadow Map Texture Config`** (1 nodes): `Common ImGui Widgets`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Alpha Channel Design`** (1 nodes): `Static Input API Design`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Input System Hook`** (1 nodes): `Input Update/EndFrame Lifecycle`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Error Handling Hook`** (1 nodes): `Stencil Buffer`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Singleton Pattern`** (1 nodes): `Separation: Material vs Renderer Responsibilities`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Input System (A_Reference)`** (2 nodes): `Ch21: Input System`, `Input`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Camera System (A_Reference)`** (2 nodes): `VizPsyche Engine (Ch0-43)`, `Singleton Pattern`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `OpenGL Loading / GLAD (A_Reference)`** (2 nodes): `Ch02: OpenGL Loading (GLAD)`, `GLAD (library)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Camera Controller & Delta Time (Docs)`** (2 nodes): `Camera`, `Ch14: Camera System`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Texture Filtering Rationale`** (1 nodes): `ImGui Frame Lifecycle`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Alpha Channel in ObjectColor`** (1 nodes): `StartWindow/EndWindow Panel API`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Engine Singleton & Book Overview`** (1 nodes): `Standard Alpha Blending`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `GLFW Window & Context`** (1 nodes): `Lower Hemisphere Fallback Color`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
## Coverage Gaps
...
### Doc concepts with no code node (224 gaps)
